...
/**
 * the [BaseEpoxyModelWithHolder] integrates epoxy with view binding
 *
 *  https://github.com/airbnb/epoxy/blob/master/kotlinsample/src/main/java/com/airbnb/epoxy/kotlinsample/helpers/ViewBindingEpoxyModelWithHolder.kt
 *
 */
abstract class BaseEpoxyModelWithHolder<in T : ViewBinding> :
